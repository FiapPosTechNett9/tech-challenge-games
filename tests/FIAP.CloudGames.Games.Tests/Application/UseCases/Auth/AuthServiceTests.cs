...
using FIAP.CloudGames.Games.Domain.Interfaces;
using FIAP.CloudGames.Games.Domain.Interfaces.Repositories;
using FIAP.CloudGames.Games.Domain.ValueObjects;
using Moq;

namespace FIAP.CloudGames.Games.Tests.Application.UseCases.Auth
{
